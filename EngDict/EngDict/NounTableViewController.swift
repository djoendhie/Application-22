...
class NounTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let url = "http://localhost/Kamus/index.php/api/getnoun"
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "cellNoun", for: indexPath) as! NounTableViewCell
        
        var serverid = arraysiswa[indexPath.row]
        
        var id = serverid["id_noun"]
        let eng = serverid["eng"]
        let indo = serverid["indo"]
        let no = serverid["id_noun"]
        //print judul
        
        cell.labelEng3.text = eng
        cell.labelIndo3.text = indo
        cell.labelNo3.text = no
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        judSelected = task["id_noun"] as! String
