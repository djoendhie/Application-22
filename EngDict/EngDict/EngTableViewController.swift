...
class EngTableViewController: UITableViewController {
...
//        print("id + " + nampungId!)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "cellEng", for: indexPath) as! EngTableViewCell
        ...
        cell.labelEng.text = eng
        cell.labelIndo.text = indo
        cell.labelNo.text = no
