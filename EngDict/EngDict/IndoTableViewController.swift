...
class IndoTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let url = "http://localhost/Kamus/index.php/api/getenglish"
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "cellIndo", for: indexPath) as! IndoTableViewCell
        
        var serverid = arraysiswa[indexPath.row]
        
        var id = serverid["id_kamus"]
        let eng = serverid["eng"]
        let indo = serverid["indo"]
        let no = serverid["id_kamus"]

        //print judul
        
        cell.labelEng1.text = eng
        cell.labelIndo1.text = indo
        cell.laeblNo1.text = no
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        judSelected = task["id_kamus"] as! String
